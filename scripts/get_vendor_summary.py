...
def create_vendor_summary(conn):
    '''this func will merge different tables to get the overall vendor summary and adding new columns in the resultant data'''
...
def clean_data(df):
    '''this function will clearn the data'''
